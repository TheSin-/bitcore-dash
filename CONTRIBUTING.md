# Contributing to Bitcore-Terracoin

We're working hard to make *bitcore-terracoin* the most powerful JavaScript library for working with Terracoin. Our goal is to have *bitcore-terracoin* be a library that can be used by anyone interested in Terracoin, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-terracoin to which any change should adhere.
